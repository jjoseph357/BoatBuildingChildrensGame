# Shop menu and helper guide

Print this document for the helper running the materials store. Tape pages 1 and 2 to the front of the shop table so campers can read the prices. Keep the helper guide pages behind the table.
...
| Plastic cup (Solo cup) | 3 chips | 1 cup (16 oz) | Deep cargo bay or hull section. |
| Foam / paper bowl | 4 chips | 1 bowl (12 oz) | Stable wide hull shape. |
| Jumbo craft sticks | 2 chips | Bundle of 5 sticks | Frame struts, outriggers, and bridges. |
| Plastic drinking straws | 2 chips | Bundle of 5 straws | Lightweight frame supports and masts. |

### Adhesives and fasteners
| Item | Cost | Unit | Notes |
|---|---|---|---|
| Heavy-duty duct tape | 5 chips | 1 arm-length strip (~2.5 ft) | Waterproof seal and strong structural joints. |
...
## Helper guide: How to run the shop
...
### Measuring tape
Do not hand campers entire tape rolls. You dispense tape by the strip:
1. Pull the tape from the roll.
2. Measure one arm length, stretching from your fingertips to your shoulder (roughly 2.5 to 3 feet).
...
### Closing the shop
- At minute 33 (5 minutes before closing), announce: "Final call for materials! 5 minutes until the shop closes forever!"
- At minute 38, close the shop box and sit down. Do not sell tape or materials after minute 38, even if kids beg. Fairness requires a hard deadline.

---

## Shopkeeper inventory tracking sheet

Copy this table or keep it on a clipboard during the event to track sales and inventory:
...
| Foil sheets (12"x12") | 40 | | |
| Plastic Solo cups | 25 | | |
| Foam / paper bowls | 25 | | |
| Craft sticks (packs of 5) | 30 | | |
| Straws (packs of 5) | 30 | | |
| Duct tape strips | 60 | | |
