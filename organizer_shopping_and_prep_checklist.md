...
## 1. Supplies to collect for free (Start 1-2 weeks early)
...
## 2. Shopping list (Dollar store, grocery store, hardware store)
...
| Foam pool noodles | 2 standard noodles | Dollar store / Walmart | \$3 - \$5 | Slice into 2-inch donut rings before the game. |
| Jumbo wooden craft sticks | 1 box (150-200 count) | Craft store / Dollar store | \$3 - \$5 | For deck framing and outriggers. |
...
| Item | Recommended quantity | Where to buy | Estimated cost | Notes |
|---|---|---|---|---|
| Blunt-tip safety scissors | 8 to 10 pairs | Camp craft supply / Dollar store | \$8 - \$10 | Exactly 1 pair loaned per team. |
...
## 3. Advance prep (The night before or morning of)

Do not leave these prep steps for game time:
...
## 4. Room layout and table setup

Arrange the room into four distinct zones:
